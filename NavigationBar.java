...
public class NavigationBar extends HBox
{
	...
	public NavigationBar(WebView webView, String homePageUrl, boolean goToHomePage)
	{
		...
		// Add an ActionListener for the Login Button
		loginButton.setOnAction(new EventHandler<ActionEvent>()
		{
			@Override
			public void handle(ActionEvent event)
			{
				//create a page to handle user profile details
				//store name, location in an array
				//when session closes, store array in csv file
			}
		});
		...
		this.getChildren().addAll(label, pageUrl,goButton, refreshButton, homeButton, openButton, loginButton);
